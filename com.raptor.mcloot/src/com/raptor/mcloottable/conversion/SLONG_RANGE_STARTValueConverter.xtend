...
class SLONG_RANGE_STARTValueConverter extends AbstractLexerBasedConverter<Long> {
    ...
    override protected assertValidValue(Long value) {
        ...
        if (value >= 0)
            throw new ValueConverterException('''«ruleName»-value may not be positive (value: «value»).''', null, null)
    }
